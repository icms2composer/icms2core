...
use icms2\core\Controller as cmsController;
use icms2\core\Request as cmsRequest;
use icms2\core\User as cmsUser;
use icms2\core\Form as cmsForm;
use icms2\core\Queue as cmsQueue;
use icms2\core\Permissions as cmsPermissions;
use icms2\core\EventsManager as cmsEventsManager;

class Backend extends cmsController {
